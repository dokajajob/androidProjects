package com.dokajajob.grocerieslisted.Data;
...
import com.dokajajob.grocerieslisted.Activities.DetailsActivity;
import com.dokajajob.grocerieslisted.Model.Grocery;
import com.dokajajob.grocerieslisted.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    //Updated Grocery DetailsActivity
    public int updateGroceryDet(DetailsActivity detailsActivity) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(Constants.KEY_GROCERY_ITEM, detailsActivity.getGname());
        values.put(Constants.KEY_QTY_NUMBER, detailsActivity.getGqty());
        values.put(Constants.KEY_DATE_NAME, System.currentTimeMillis());//get system time


        //update row
        return db.update(Constants.TABLE_NAME, values, Constants.KEY_ID + "=?", new String[] { String.valueOf(detailsActivity.getGkey())} );
    }
